...
import { deployXToken, deployYToken, deployNFT, deployNFTSale, deployTreasury } from "../utils/deployContracts"
import { currentTimestamp, increaseTimeDays } from "../utils/helpers"
import { NFTSale, NFT, Treasury, XToken } from "../typechain";
...
describe("Test", function () {
  ...
  it("setURI works", async() => {
    await nft.connect(await getGnosisWithEther(nft)).setUri("https://fake.url/metadata/")
    expect(await nft.tokenURI(777)).to.be.equal("https://fake.url/metadata/777")
  })
