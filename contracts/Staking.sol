...
contract Staking is OwnableUpgradeable {
    ...
    event OptionStateSet(uint256 option, bool state);
    event OptionSet(
        uint256 option,
        uint256 lockPeriod,
        uint256 apy,
    ...
    address public constant GNOSIS = 0x0000000000000000000000000000000000000004;
    uint256[50] __gap;
    ...
    function setOptionState(uint256 _option, bool _state) external onlyOwner {
        ...
        emit OptionStateSet(_option, _state);
    }
    ...
    function setOption(
        ...
        emit OptionSet(_option, _lockPeriod, _apy, _minValue, _maxValue);
    }
    ...
    function addOption(
        ...
        emit OptionAdd(_lockPeriod, _apy, _minValue, _maxValue);
    }
